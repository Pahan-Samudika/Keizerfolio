...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    emailjs.send('service_96t1ww7','template_3mjhisn',
      {
        from_name: form.name,
        to_name: 'Pahan',
        from_email: form.email,
        to_email: 'pahanabhayawardhane@gmail.com',
  ...
  return (
    <div className='xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      ...
      >
        <p className={`${styles.sectionSubText} flex justify-end`}>Get in touch</p>
        <h3 className={`${styles.sectionHeadText} flex justify-end`}>Contact</h3>
